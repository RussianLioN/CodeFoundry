...
> **🚨 ПРИОСТАНОВЛЕНО (2026-02-13) — ОЧИСТКА ВЫПОЛНЕНА**
>
> **Решение:** Expert Consilium (consensus: 0.76) — временно отключить OpenClaw на сервере.
> **Выполнено:**
> - ✅ Контейнеры остановлены и удалены (gateway, telegram-bot, claude-runner)
> - ✅ Образы удалены (~405MB освобождено)
> - ✅ Backup сохранён: `~/backups/openclaw-20260213/`
> **Восстановление:** `cd /root/projects/CodeFoundry/server && docker compose -f docker-compose.orchestrator.yml up -d`
>
